	...
	theme: {
		...
		extend: {
			...
			backgroundImage: {
				...
				'gradient-surface': 'linear-gradient(135deg, var(--gradient-surface-start), var(--gradient-surface-end))',
				'gradient-glass': 'linear-gradient(135deg, color-mix(in srgb, hsl(var(--primary)) 20%, transparent), color-mix(in srgb, hsl(var(--primary)) 8%, transparent))'
			},
			borderRadius: {
				lg: 'var(--radius)',
